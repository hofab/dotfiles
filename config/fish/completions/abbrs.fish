...
#useful stuff
abbr --add ei       'nvim ~/dotfiles/config/i3/config'
abbr --add et       'nvim ~/dotfiles/config/tmux.conf'
abbr --add evrc     'nvim ~/dotfiles/config/nvim/init.vim'
abbr --add efc      'nvim ~/dotfiles/config/fish/config.fish'
abbr --add efa      'nvim ~/dotfiles/config/fish/completions/abbrs.fish'
abbr --add zd       'z ~/Downloads'
abbr --add o        'nvim'
abbr --add sd       'eza -lR | rg -i'
