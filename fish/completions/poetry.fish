...
complete -c poetry -n '__fish_poetry_622a08420f197242_complete_no_subcommand' -l directory -d 'The working directory for the Poetry command (defaults to the current working directory).'
...
complete -c poetry -f -n '__fish_poetry_622a08420f197242_complete_no_subcommand' -a add -d 'Adds a new dependency to pyproject.toml and installs it.'
...
complete -c poetry -f -n '__fish_poetry_622a08420f197242_complete_no_subcommand' -a cache
...
complete -c poetry -f -n '__fish_poetry_622a08420f197242_complete_no_subcommand' -a check -d 'Validates the content of the pyproject.toml file and its consistency with the poetry.lock file.'
complete -c poetry -f -n '__fish_poetry_622a08420f197242_complete_no_subcommand' -a config -d 'Manages configuration settings.'
complete -c poetry -f -n '__fish_poetry_622a08420f197242_complete_no_subcommand' -a debug
...
complete -c poetry -f -n '__fish_poetry_622a08420f197242_complete_no_subcommand' -a env
...
complete -c poetry -f -n '__fish_poetry_622a08420f197242_complete_no_subcommand' -a self
...
complete -c poetry -f -n '__fish_poetry_622a08420f197242_complete_no_subcommand' -a source
