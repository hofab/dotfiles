...
complete -c poetry -n '__fish_poetry_622a08420f197242_complete_no_subcommand' -l help -d 'Display this help message'
...
complete -c poetry -n '__fish_poetry_622a08420f197242_complete_no_subcommand' -l verbose -d 'Increase the verbosity of messages: "-v" for normal output, "-vv" for more verbose output and "-vvv" for debug'
...
complete -c poetry -f -n '__fish_poetry_622a08420f197242_complete_no_subcommand' -a cache -d 'Interact with Poetry\'s cache'
...
complete -c poetry -f -n '__fish_poetry_622a08420f197242_complete_no_subcommand' -a debug -d 'Debug various elements of Poetry.'
complete -c poetry -f -n '__fish_poetry_622a08420f197242_complete_no_subcommand' -a env -d 'Interact with Poetry\'s project environments.'
...
complete -c poetry -f -n '__fish_poetry_622a08420f197242_complete_no_subcommand' -a help -d 'Display the manual of a command'
...
complete -c poetry -f -n '__fish_poetry_622a08420f197242_complete_no_subcommand' -a self -d 'Interact with Poetry directly.'
